...
## Project Structure
    ...
    ├── the_weight_room_app_31882  # Django project configurations
...
1. Clone this repo and `cd the_weight_room_app_31882`
...
2. Clone this repo and `cd the_weight_room_app_31882`
